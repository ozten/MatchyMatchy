//! ISO locale code data, generated from the system `iso-codes` package
//! (/usr/share/iso-codes/json/iso_639-2.json and iso_3166-1.json) by
//! testbed tooling — do not hand-edit. Sorted ascending for binary_search.

/// ISO 639-1 two-letter language codes (184 entries).
pub const ISO_639_1: &[&str] = &[
...
/// ISO 3166-1 alpha-2 region codes (249 entries).
